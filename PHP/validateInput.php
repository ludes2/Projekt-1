...
include_once "db.php";
    ...
    if ($idCounter <= 4) {
        ...
        if (isset($_POST['jsonDuration'])) {
            ...
            $stmt = $db->prepare("INSERT INTO projekt1.durations (durations, dur_id, user_id) VALUES('$duration', $idCounter + 1, '5')");
            $stmt->execute();
        }
    }
    ...
    if ($idCounter <= 5) {
        ...
        if (isset($_POST['jsonLatency'])) {
            ...
            $stmt = $db->prepare("INSERT INTO projekt1.latencies (latencies, lat_id, user_id) VALUES('$latency', $idCounter, '5')");
            $stmt->execute();
        }
        ...
        if (isset($_POST['jsonInterval'])) {
            ...
            $stmt = $db->prepare("INSERT INTO projekt1.intervals (intervals, interval_id, user_id) VALUES('$interval', $idCounter, '5')");
            $stmt->execute();
        }
    }
